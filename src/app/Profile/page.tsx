  ...
  return (
    <div className="relative flex flex-col h-full min-h-screen w-full gap-4 bg-[url('/profile/bg.webp')] md:mx-auto md:max-w-[25rem]">
        ...
        <div className="flex flex-row">
          <div className="flex flex-col basis-1/2 justify-center items-center space-y-6">
            <div className="flex flex-col justify-center items-center">
              <div className="flex flex-row grow justify-center items-center space-x-2">
                <input
                  id="nameInput"
                  type="text"
                  value={name}
          ...
          <div className="flex flex-col basis-1/2 justify-center items-center space-y-4">
            <div className="flex flex-col justify-center items-center bg-[#ECF0F6] w-28 h-28 rounded-full">
              stamp
            </div>
            <div className="bg-[#ECF0F6] text-sm rounded-md w-16 h-6 items-center flex justify-center font-semibold">
              <Link href="/Profile/dress">
                fashion
              </Link>
            </div>
            <div className="bg-[#ECF0F6] w-36 h-44 flex justify-center items-center">
              model
            </div>
          </div>
        </div>
